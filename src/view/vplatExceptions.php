                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 text-center mb100">
                            ...
                            <h3 class="section-heading theme-accent-color"><?= $message ?></h3>
                        </div>
                    </div>
                </div>
                <div class="container">
                    <div class="row">
                        <div class="col-md-10 col-md-offset-1">
                            <div class="row">
                                <form method="get" action="<?= WEBAPP_ROOT ?>webapp/platt.php" class="form-group  col-md-12 wow fadeIn" data-wow-delay="0.2s">
